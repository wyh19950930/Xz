...
import com.chuzhi.xzyx.databinding.ActivityGoogleMapBinding
...
class GoogleMapActivity : BaseActivity<ActivityGoogleMapBinding,BasePresenter<*>>(),
    OnMapReadyCallback {
    ...
    override fun initView() {
        ...
        supportMapFragment =
            supportFragmentManager.findFragmentById(R.id.act_google_map_frag) as? SupportMapFragment
...
//        var sydney = LatLng(-33.867, 151.206)
//        p0.isMyLocationEnabled = true
//        p0.moveCamera(CameraUpdateFactory.newLatLngZoom(sydney, 13F))
//
//        p0.addMarker(
//            MarkerOptions()
//                .title("Sydney")
