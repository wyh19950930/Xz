...
public class PrivacyDialog {
    ...
    public PrivacyDialog builder() {
        View view = LayoutInflater.from(context).inflate(
                R.layout.view_privacy_dialog, null);

        lLayout_bg = (LinearLayout) view.findViewById(R.id.privacy_lLayout_bg);
        txt_title = (TextView) view.findViewById(R.id.privacy_txt_title);
        txt_msg = (TextView) view.findViewById(R.id.privacy_txt_msg);
        btn_neg = (Button) view.findViewById(R.id.privacy_btn_neg);
        btn_pos = (Button) view.findViewById(R.id.privacy_btn_pos);
        img_line = (ImageView) view.findViewById(R.id.privacy_img_line);
        setGone();
     ...
     * @return
     */
    public PrivacyDialog setMsg(String msg) {
        showMsg = true;
    ...
    public void setSpannableStringBuilder(String msg) {
        ...
        spannableStringBuilder.setSpan(clickableSpan,17,24, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        spannableStringBuilder.setSpan(clickableSpan1,26,31, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        ...
        spannableStringBuilder.setSpan(colorSpan,17,25,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        spannableStringBuilder.setSpan(colorSpan1,26,32,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
     ...
     * @return
     */
    public PrivacyDialog setCancelable(boolean cancel) {
     ...
     * @return
     */
    public PrivacyDialog setPositiveButton(String text,
                                           final OnClickListener listener) {
        return setPositiveButton(text, -1, listener);
    }

    public PrivacyDialog setPositiveButton(String text, int color,
                                           final OnClickListener listener) {
        showPosBtn = true;
        if ("".equals(text)) {
            btn_pos.setText("");
    ...
    public PrivacyDialog setPositiveButtonNoDismiss(String text, int color,
                                                    final OnClickListener listener) {
        showPosBtn = true;
        if ("".equals(text)) {
            btn_pos.setText("");
    ...
    public PrivacyDialog setNegativeButton(String text,
                                           final OnClickListener listener) {

        return setNegativeButton(text, -1, listener);
    }

    public PrivacyDialog setNegativeButton(String text, int color,
                                           final OnClickListener listener) {
        showNegBtn = true;
        if ("".equals(text)) {
            btn_neg.setText("");
