package com.chuzhi.xzyx.utils.apputils;
...
public final class AppUtils {
     ...
     */
    public static void installApp(String filePath, String authority,Context context) {
    ...
    public static void installApp(Context context,File file, String authority) {
        ...
        MyApplication.Companion.getInstance().startActivity(IntentUtils.getInstallAppIntent(context,file, authority+".provider"));
    }
    ...
    public static void uninstallApp(String packageName) {
        ...
        MyApplication.Companion.getInstance().startActivity(IntentUtils.getUninstallAppIntent(packageName));
    }
...
//            LogUtils.d("isAppRoot", result.errorMsg);
    ...
    public static void launchApp(String packageName) {
        if (isSpace(packageName)) return;
        MyApplication.Companion.getInstance().startActivity(IntentUtils.getLaunchAppIntent(packageName));
    }
    ...
    public static String getAppPackageName() {
        return MyApplication.Companion.getInstance().getPackageName();
    }
    ...
    public static void getAppDetailsSettings() {
        getAppDetailsSettings(MyApplication.Companion.getInstance().getPackageName());
    }
    ...
    public static void getAppDetailsSettings(String packageName) {
        if (isSpace(packageName)) return;
        MyApplication.Companion.getInstance().startActivity(IntentUtils.getAppDetailsSettingsIntent(packageName));
    }
    ...
    public static String getAppName() {
        return getAppName(MyApplication.Companion.getInstance().getPackageName());
    }
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(MyApplication.Companion.getInstance().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(MyApplication.Companion.getInstance().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(MyApplication.Companion.getInstance().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(MyApplication.Companion.getInstance().getPackageName());
    }
    ...
    public static int getAppVersionCode(String packageName) {
        if (isSpace(packageName)) return -1;//判断包名是否不包含空格
        try {
            PackageManager pm = MyApplication.Companion.getInstance().getPackageManager();
            PackageInfo pi = pm.getPackageInfo(packageName, 0);
    ...
    public static boolean isSystemApp() {
        return isSystemApp(MyApplication.Companion.getInstance().getPackageName());
    }
    ...
    public static boolean isAppDebug() {
        return isAppDebug(MyApplication.Companion.getInstance().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(MyApplication.Companion.getInstance().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(MyApplication.Companion.getInstance().getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        ActivityManager manager = (ActivityManager) MyApplication.Companion.getInstance().getSystemService(Context.ACTIVITY_SERVICE);
        List<ActivityManager.RunningAppProcessInfo> info = manager.getRunningAppProcesses();
        if (info == null || info.size() == 0) return false;
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                return aInfo.processName.equals(MyApplication.Companion.getInstance().getPackageName());
            }
        }
        return false;
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(MyApplication.Companion.getInstance().getPackageName());
    }
    ...
    private static boolean isSpace(String s) {//判断包名是否不包含空格
    ...
    public static boolean isLocServiceEnable() {
        LocationManager locationManager = (LocationManager) MyApplication.Companion.getInstance().getSystemService(Context.LOCATION_SERVICE);
