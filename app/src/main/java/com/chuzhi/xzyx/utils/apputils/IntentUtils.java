...
public final class IntentUtils {
    ...
    public static Intent getInstallAppIntent(Context context,File file, String authority) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            data = FileProvider.getUriForFile(MyApplication.Companion.getInstance(), authority, file);
        }
...
//        context.startActivity(intent);
    ...
    public static Intent getLaunchAppIntent(String packageName) {
        return MyApplication.Companion.getInstance().getPackageManager().getLaunchIntentForPackage(packageName);
    }
