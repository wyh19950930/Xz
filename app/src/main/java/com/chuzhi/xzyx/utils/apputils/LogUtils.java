    ...
    public static class Builder {
        public Builder() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && MyApplication.Companion.getInstance().getExternalCacheDir() != null)
                defaultDir = MyApplication.Companion.getInstance().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                defaultDir = MyApplication.Companion.getInstance().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
