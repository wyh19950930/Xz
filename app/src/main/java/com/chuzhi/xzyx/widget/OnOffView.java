...
import com.chuzhi.xzyx.utils.DensityUtils;

/**
 * @Author : wyh
 * @Time : On 2023/6/5 15:09
 * @Description : OnOffView
 */
public class OnOffView extends FrameLayout implements View.OnClickListener {
    ...
    private void initIcon(){
        ...
        //小球圆角角度
        drawable.setCornerRadius(DensityUtils.dp2px(getContext(),50f));
        //外框颜色
        drawable.setStroke(DensityUtils.dp2px(getContext(),1f), Color.parseColor("#EEEEEE"));
        if (defOff)
